...
La fonction de filtrage travaille sur des transformée "shiftées" par la fonction fftshift, cela permet d'avoir un représentation plus proche de ce qu'un analyseur de spectre renverait et donc plus intuitif pour programmer un filtre.
